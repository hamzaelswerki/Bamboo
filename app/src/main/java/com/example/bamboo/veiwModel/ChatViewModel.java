...
public class ChatViewModel extends AndroidViewModel {
    ...
    public MutableLiveData<FirestoreRecyclerOptions<Chat>> getListMessages(String idForBranchDocument, Context context) {

        Query query = FirebaseFirestore.getInstance().collection("branchs").
                document(idForBranchDocument)
                .collection(SharedPrefHelper.getToken(context)).orderBy("time");
