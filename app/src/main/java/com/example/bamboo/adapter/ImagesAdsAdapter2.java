...
public class ImagesAdsAdapter2 extends PagerAdapter {
  ...
  Context context;
   ...
   public void setOnImageListener(OnImageListener onImageListener){
    ...
    public ImagesAdsAdapter2(Context context, List<String> adsList){
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        TextView textView = view.findViewById(R.id.textView15);
          ...
          if (adsList.get(position)!=null)
              Glide.with(context).load(adsList.get(position) ).into(imageView);
